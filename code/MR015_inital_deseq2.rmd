...
#### import data
```{r}
txi <- salmon_import("/project/imoskowitz/shared/sequencing.processed/170811_K00242_0263_AHKVG5BBXX-IM-JJL-RS6/star_salmon")
```

#### import metadata
```{r}

metadata  <- load_metadata("/project/imoskowitz/shared/metasheets/sample_sheets/MR015_170811_K00242_0263_AHKVG5BBXX-IM-JJL-RS6_Sample_metasheet_v18.xlsx")
```
...
treatment="ShhKO_aSHF_E10.5", control="ShhWT_aSHF_E10.5")
...
pdf(file = "pdfs/heatmap_sample_cor.pdf", height = 5, width = 5)
assay(vst) |>
  cor() |>
...
ggtitle("aSHF_E10.5 ShhKO/ShhWT")
  
ggsave(filename = "pdfs/volcano_ShhKO_aSHF_E10.5_v_ShhWT_aSHF_E10.5.pdf",
plot = last_plot(),
device = "pdf",
width = 5, height = 5)
dev.off()
...
ggsave(filename = "pdfs/GO_BP_ShhKO_aSHF_E10.5_v_ShhWT_aSHF_E10.5_up.pdf",
plot = last_plot(),
device = "pdf",
width = 7, height = 5)
dev.off()
...
ggsave(filename = "pdfs/GO_BP_ShhKO_aSHF_E10.5_v_ShhWT_aSHF_E10.5_down.pdf",
plot = last_plot(),
device = "pdf",
width = 7, height = 5)
dev.off()

write.csv(res, "data/Table_DESeq2_ShhKO_aSHF_E10.5_v_ShhWT_aSHF_E10.5.csv")
